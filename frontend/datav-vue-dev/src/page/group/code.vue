...
import { funEval } from '@/utils/utils.min.js'
...
export default {
  ...
  watch: {
    ...
    return {}
          ...
          } else if (['query', 'header', 'dataQuery', 'dataHeader', 'websocketHeader', 'websocketQuery'].includes(this.type) && this.validatenull(val)) {
    ...
    console.log(params,refs)
          ...
          }else if (['dblClickFormatter'].includes(this.type) && this.validatenull(val)) {
            this.code = `function(params,refs){
    console.log(params,refs)
}`
