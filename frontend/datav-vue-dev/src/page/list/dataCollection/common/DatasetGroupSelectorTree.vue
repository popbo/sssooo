        ...
        <el-col :span="8">
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item @click.native="searchTypeClick('folder')">目录
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
        </el-col>
...
import { queryAuthModel, post } from '@/api/dataCollection.js'
export default {
