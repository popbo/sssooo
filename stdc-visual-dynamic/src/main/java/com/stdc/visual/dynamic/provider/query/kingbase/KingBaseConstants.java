...
import static com.stdc.visual.dynamic.base.datasource.dto.DatasourceTypes.kingbase;
...
public class KingBaseConstants extends SQLConstants {
    ...
    public static final String KEYWORD_TABLE = kingbase.getKeywordPrefix() + "%s" + kingbase.getKeywordSuffix();

    public static final String KEYWORD_FIX = "%s." + kingbase.getKeywordPrefix() + "%s" + kingbase.getKeywordSuffix();
