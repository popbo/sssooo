...
import com.stdc.visual.dynamic.provider.query.gbase.GbaseConstants;
 ...
 */
@Service("gbaseQuery")
public class GbaseQueryProvider extends QueryProvider {
    ...
    public String createQuerySQL(DataSetTableRequest request, String table, List<DatasetTableField> fieldsCopy, boolean isGroup,Datasource ds, List<ChartFieldCustomFilterDTO> fieldCustomFilterCopy) {
        ...
        SQLObj tableObj = SQLObj.builder()
                .tableName((table.startsWith("(") && table.endsWith(")")) ? table : String.format(GbaseConstants.KEYWORD_TABLE, table))
        ...
        if (CollectionUtils.isNotEmpty(fields)) {
            for (int i = 0; i < fields.size(); i++) {
                ...
                if (ObjectUtils.isNotEmpty(f.getExtField()) && f.getExtField() == 2) {
                    ...
                    originField = String.format(GbaseConstants.KEYWORD_FIX, tableObj.getTableAlias(), f.getOriginName());
                } else {
                    originField = String.format(GbaseConstants.KEYWORD_FIX, tableObj.getTableAlias(), f.getOriginName());
                }
...
//                                    dataFieldName = String.format(GbaseConstants.DATE_FORMAT, originField, GbaseConstants.YEAR_DATE_FORMAT);
//                                    break;
//                                case DateFormatCondition.QUARTER:
//                                    dataFieldName = String.format(GbaseConstants.QUARTER_DATE_FORMAT, originField);
//                                    break;
//                                case DateFormatCondition.MONTH:
//                                    dataFieldName = String.format(GbaseConstants.DATE_FORMAT, originField, GbaseConstants.MONTH_DATE_FORMAT);
//                                    break;
//                                case DateFormatCondition.WEEK:
//                                    dataFieldName = String.format(GbaseConstants.DATE_FORMAT, originField, GbaseConstants.WEEK_DATE_FORMAT);
//                                    break;
//                                case DateFormatCondition.DAY:
//                                    dataFieldName = String.format(GbaseConstants.DATE_FORMAT, originField, GbaseConstants.DAY_DATE_FORMAT);
//                                    break;
//                                case DateFormatCondition.HOUR:
//                                    dataFieldName = String.format(GbaseConstants.DATE_FORMAT, originField, GbaseConstants.HOUR_DATE_FORMAT);
//                                    break;
//                                case DateFormatCondition.ACCURATE:
//                                    dataFieldName = String.format(GbaseConstants.DATE_FORMAT, originField, GbaseConstants.DEFAULT_DATE_FORMAT);
//                                    break;
//                                default:
//                                    break;
//                            }
...
//                }
                // 处理横轴字段
                //设置时间展示格式
                String dataFormat = GbaseConstants.DEFAULT_DATE_FORMAT;
                //是否需要替换
                ...
                if (ObjectUtils.isNotEmpty(request)
                    ...
                    for (DateFormatCondition dateFormatCondition : request.getFieldCondition().getDateFormatConditionS()) {
                        ...
                        if (StringUtils.equals(f.getId(), dateFormatCondition.getFieldId())) {
                            ...
                            switch (dateFormatCondition.getGranularity()){
                                case DateFormatCondition.YEAR:
                                    dataFormat = GbaseConstants.YEAR_DATE_FORMAT;
                                    break;
                                case DateFormatCondition.QUARTER:
                                    dataFormat = GbaseConstants.QUARTER_DATE_FORMAT;
                                    break;
                                case DateFormatCondition.MONTH:
                                    dataFormat = GbaseConstants.MONTH_DATE_FORMAT;
                                    break;
                                case DateFormatCondition.WEEK:
                                    dataFormat = GbaseConstants.WEEK_DATE_FORMAT;
                                    break;
                                case DateFormatCondition.DAY:
                                    dataFormat = GbaseConstants.DAY_DATE_FORMAT;
                                    break;
                                case DateFormatCondition.HOUR:
                                    dataFormat = GbaseConstants.HOUR_DATE_FORMAT;
                                    break;
                                case DateFormatCondition.MINUTE:
                                    dataFormat = GbaseConstants.MINUTE_DATE_FORMAT;
                                    break;
                                case DateFormatCondition.ACCURATE:
                                    dataFormat = GbaseConstants.DEFAULT_DATE_FORMAT;
                                    break;
                                default:
                                    break;
                            }
                ...
                if (f.getDeExtractType() == 1) {
                    if (f.getDeType() == 2 || f.getDeType() == 3) {
                        fieldName = String.format(GbaseConstants.UNIX_TIMESTAMP, originField) + "*1000";
                    } else {
...
//						fieldName = String.format(GbaseConstants.STR_TO_DATE, originField, dataFormat);
                        if (isNeedReplace && StringUtils.isNotBlank(dataFormat)) {
                            //数据格式为 “季度” 的情况
                            fieldName = String.format(GbaseConstants.CAST, String.format(GbaseConstants.QUARTER_DATE_FORMAT, originField), "CHAR");
                            fieldName = String.format(GbaseConstants.REPLACE, dataFormat, "%s", fieldName);
                        } else {
                            fieldName = String.format(GbaseConstants.DATE_FORMAT, originField, dataFormat);
                        }
                    } else {
                        fieldName = originField;
                    }
                    ...
                    if (f.getDeType() == 1) {
                        ...
                        fieldName = String.format(GbaseConstants.FROM_UNIXTIME, cast, GbaseConstants.DEFAULT_DATE_FORMAT);
...
//                                .fieldAlias(fieldAlias)
        ...
        if (CollectionUtils.isNotEmpty(groupFields)) st_sql.add("customGroups", groupFields);
    ...
    public String createQuerySQL(String table, List<DatasetTableField> fieldsCopy, boolean isGroup,Datasource ds, List<ChartFieldCustomFilterDTO> fieldCustomFilterCopy) {
        ...
        if (CollectionUtils.isNotEmpty(fields)) {
            for (int i = 0; i < fields.size(); i++) {
                ...
                // 处理横轴字段
                //设置时间展示格式
                String dataFormat = GbaseConstants.DAY_DATE_FORMAT;
                //是否需要替换
                Boolean isNeedReplace = false;
                if(ObjectUtils.isNotEmpty(superRequest)
                        && ObjectUtils.isNotEmpty(superRequest.getFieldCondition())
...
//				} else if (f.getDeExtractType() == 0) {
//					if (f.getDeType() == 2) {
//						fieldName =String.format(GbaseConstants.CAST, originField, GbaseConstants.DEFAULT_INT_FORMAT);
//					} else if (f.getDeType() == 3) {
//						fieldName = String.format(GbaseConstants.CAST, originField, GbaseConstants.DEFAULT_INT_FORMAT);
//					} else if (f.getDeType() == 1) {
////						fieldName = String.format(GbaseConstants.STR_TO_DATE, originField, GbaseConstants.DEFAULT_DATE_FORMAT);
//						if (isNeedReplace && StringUtils.isNotBlank(dataFormat)){
//							//数据格式为 “季度” 的情况
//							fieldName = String.format(GbaseConstants.CAST,String.format(GbaseConstants.QUARTER_DATE_FORMAT, originField),"CHAR");
//							fieldName = String.format(GbaseConstants.REPLACE,dataFormat,"%s",fieldName);
...
//				} else {
//					if (f.getDeType() == 1) {
//						String cast = String.format(GbaseConstants.CAST, originField, GbaseConstants.DEFAULT_INT_FORMAT)+ "/1000";
//						fieldName = String.format(GbaseConstants.FROM_UNIXTIME, cast, GbaseConstants.DEFAULT_DATE_FORMAT);
//					} else if (f.getDeType() == 2) {
//						fieldName = String.format(GbaseConstants.CAST, originField, GbaseConstants.DEFAULT_INT_FORMAT);
//					} else {
...
//	}
            ...
            for (int i = 0; i < fields.size(); i++) {
                ...
                if (f.getDeExtractType() == 1) {
                    ...
                    if (f.getDeType() == 2) {
                        ...
                        fieldName = String.format(GbaseConstants.CAST, originField, GbaseConstants.DEFAULT_FLOAT_FORMAT);
                    } else if (f.getDeType() == 1) {
                        fieldName = String.format(GbaseConstants.STR_TO_DATE, originField, GbaseConstants.DEFAULT_DATE_FORMAT);
                    } else {
                        fieldName = originField;
    ...
    public String convertTableToSql(String tableName, Datasource ds) {
        return createSQLPreview("SELECT * FROM " + String.format(GbaseConstants.KEYWORD_TABLE, tableName), null);
    }
    ...
    public String transCustomFilterListWithMeasureFieldS(SQLObj tableObj, List<ChartFieldCustomFilterDTO> requestList, String measureField) {
        ...
        for (ChartFieldCustomFilterDTO request : requestList) {
            ...
            if (ObjectUtils.isNotEmpty(field.getExtField()) && field.getExtField() == 2) {
                ...
                originName = String.format(GbaseConstants.KEYWORD_FIX, tableObj.getTableAlias(), field.getOriginName());
            } else {
                //带上表名  type -> phone.`type`
                originName = String.format(GbaseConstants.KEYWORD_FIX, tableObj.getTableAlias(), field.getOriginName());
            }
            ...
            if (field.getDeType() == 1) {
                ...
                if (field.getDeExtractType() == 0 || field.getDeExtractType() == 5) {
                    ...
                    whereName = String.format(GbaseConstants.STR_TO_DATE, originName, GbaseConstants.DEFAULT_DATE_FORMAT);
                }
                //判断de抽取类型为 2,3,4
                if (field.getDeExtractType() == 2 || field.getDeExtractType() == 3 || field.getDeExtractType() == 4) {
                    //转换 CAST(field AS DECIMAL(20,2))/1000 设置列的范围并且/1000
                    String cast = String.format(GbaseConstants.CAST, originName, GbaseConstants.DEFAULT_INT_FORMAT) + "/1000";
                    //转换时间戳为具体格式时间 FROM_UNIXTIME(CAST(field AS DECIMAL(20,2))/1000 ,'%Y-%m-%d %H:%i:%S')
                    whereName = String.format(GbaseConstants.FROM_UNIXTIME, cast, GbaseConstants.DEFAULT_DATE_FORMAT);
                }
                //判断de抽取类型为 1
                if (field.getDeExtractType() == 1) {
                    if (measureField.contains(field.getId())) {
                        //默认 `tableAlias`.`fieldAlias`
                        whereName = String.format(GbaseConstants.SUM, String.format(GbaseConstants.CAST, originName, GbaseConstants.DEFAULT_INT_FORMAT));
                    } else {
                        //默认 `tableAlias`.`fieldAlias`
                ...
                if (field.getDeExtractType() == 0 || field.getDeExtractType() == 5) {
                    if (measureField.contains(field.getId())) {
                        ...
                        whereName = String.format(GbaseConstants.CAST, originName, GbaseConstants.DEFAULT_FLOAT_FORMAT);
                    }
                }
                //判断de抽取类型为 1
                if (field.getDeExtractType() == 1) {
                    //转化 UNIX_TIMESTAMP(originName) 直接得到参数对应的时间戳
                    whereName = String.format(GbaseConstants.UNIX_TIMESTAMP, originName);
                }
                //判断de抽取类型为 2,3,4
                if (field.getDeExtractType() == 2 || field.getDeExtractType() == 3 || field.getDeExtractType() == 4) {
                    if (measureField.contains(field.getId())) {
            ...
            for (ChartCustomFilterItemDTO filterItemDTO : filter) {
                ...
                if (whereTerm.contains("IN") || whereTerm.contains("in")) {
                    ...
                    whereValue = String.format(GbaseConstants.WHERE_VALUE_BETWEEN, betweenValueS[0], betweenValueS[1]);
                } else {
                    //删除 一些where子句条件
...
//					} else
                    if (StringUtils.containsIgnoreCase(filterItemDTO.getTerm(), "in")) {
                        ...
                        whereValue = String.format(GbaseConstants.WHERE_VALUE_BLANK, value);
                        ;
                    } else {
                        //转换 `whereValue`
                        whereValue = String.format(GbaseConstants.WHERE_VALUE_VALUE, value);
                    }
                }
...
//                        //默认为常规，无小数位
//                        String format = GbaseConstants.DEFAULT_INT_FORMAT;
//                        if (ObjectUtils.isNotEmpty(measureFormatCondition)) {
//                            switch (measureFormatCondition.getFormat()) {
//                                case 0:
//                                    format = GbaseConstants.DEFAULT_INT_FORMAT;
//                                    break;
//                                case 1:
//                                    format = GbaseConstants.DEFAULT_ONE_FORMAT;
//                                    break;
//                                case 2:
//                                    format = GbaseConstants.DEFAULT_FLOAT_FORMAT;
//                                    break;
//                                case 3:
//                                    format = GbaseConstants.DEFAULT_THREE_FORMAT;
//                                    break;
//                                case 4:
//                                    format = GbaseConstants.DEFAULT_FOUR_FORMAT;
//                                    break;
//                                default:
//                                    break;
//                            }
...
//                                fieldName = String.format(GbaseConstants.AVG, String.format(GbaseConstants.CAST, originField, format));
//                                break;
//                            case PolCondition.SUM:
//                                fieldName = String.format(GbaseConstants.SUM, String.format(GbaseConstants.CAST, originField, format));
//                                break;
//                            case PolCondition.MAX:
//                                fieldName = String.format(GbaseConstants.MAX, String.format(GbaseConstants.CAST, originField, format));
//                                break;
//                            case PolCondition.MIN:
//                                fieldName = String.format(GbaseConstants.MIN, String.format(GbaseConstants.CAST, originField, format));
//                                break;
//                            default:
//                                fieldName = String.format(GbaseConstants.SUM, String.format(GbaseConstants.CAST, originField, format));
//                                break;
...
//        List<DatasetTableField> calcFields = datasetTableFieldMapper.selectByExample(datasetTableFieldExample);
        for (DatasetTableField ele : calcFields) {
            originField = originField.replaceAll("\\[" + ele.getId() + "]",
                    String.format(GbaseConstants.KEYWORD_FIX, tableObj.getTableAlias(), ele.getOriginName()));
        }
        return originField;
    }
}
