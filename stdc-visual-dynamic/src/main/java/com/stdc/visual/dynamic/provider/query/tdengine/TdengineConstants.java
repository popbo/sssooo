 ...
 */
public class TdengineConstants extends SQLConstants {
    ...
    public static final String DEFAULT_ONE_FORMAT = "DOUBLE";

    public static final String DEFAULT_FLOAT_FORMAT = "DOUBLE";

    public static final String DEFAULT_THREE_FORMAT = "DOUBLE";

    public static final String DEFAULT_FOUR_FORMAT = "DOUBLE";
